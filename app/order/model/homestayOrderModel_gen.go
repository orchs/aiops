...
var (
	...
	cacheaiopsOrderHomestayOrderIdPrefix = "cache:aiopsOrder:homestayOrder:id:"
	cacheaiopsOrderHomestayOrderSnPrefix = "cache:aiopsOrder:homestayOrder:sn:"
)
...
func (m *defaultHomestayOrderModel) Insert(ctx context.Context, session sqlx.Session, data *HomestayOrder) (sql.Result, error) {
	...
	aiopsOrderHomestayOrderIdKey := fmt.Sprintf("%s%v", cacheaiopsOrderHomestayOrderIdPrefix, data.Id)
	aiopsOrderHomestayOrderSnKey := fmt.Sprintf("%s%v", cacheaiopsOrderHomestayOrderSnPrefix, data.Sn)
	...
	}, aiopsOrderHomestayOrderIdKey, aiopsOrderHomestayOrderSnKey)
}

func (m *defaultHomestayOrderModel) FindOne(ctx context.Context, id int64) (*HomestayOrder, error) {
	aiopsOrderHomestayOrderIdKey := fmt.Sprintf("%s%v", cacheaiopsOrderHomestayOrderIdPrefix, id)
	var resp HomestayOrder
	err := m.QueryRowCtx(ctx, &resp, aiopsOrderHomestayOrderIdKey, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) error {
...
func (m *defaultHomestayOrderModel) FindOneBySn(ctx context.Context, sn string) (*HomestayOrder, error) {
	aiopsOrderHomestayOrderSnKey := fmt.Sprintf("%s%v", cacheaiopsOrderHomestayOrderSnPrefix, sn)
	var resp HomestayOrder
	err := m.QueryRowIndexCtx(ctx, &resp, aiopsOrderHomestayOrderSnKey, m.formatPrimary, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) (i interface{}, e error) {
...
func (m *defaultHomestayOrderModel) formatPrimary(primary interface{}) string {
	return fmt.Sprintf("%s%v", cacheaiopsOrderHomestayOrderIdPrefix, primary)
}
