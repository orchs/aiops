...
var (
	...
	cacheaiopsTravelHomestayActivityIdPrefix = "cache:aiopsTravel:homestayActivity:id:"
)
...
func (m *defaultHomestayActivityModel) Insert(ctx context.Context, session sqlx.Session, data *HomestayActivity) (sql.Result, error) {
	...
	aiopsTravelHomestayActivityIdKey := fmt.Sprintf("%s%v", cacheaiopsTravelHomestayActivityIdPrefix, data.Id)
	...
	}, aiopsTravelHomestayActivityIdKey)
}

func (m *defaultHomestayActivityModel) FindOne(ctx context.Context, id int64) (*HomestayActivity, error) {
	aiopsTravelHomestayActivityIdKey := fmt.Sprintf("%s%v", cacheaiopsTravelHomestayActivityIdPrefix, id)
	var resp HomestayActivity
	err := m.QueryRowCtx(ctx, &resp, aiopsTravelHomestayActivityIdKey, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) error {
...
func (m *defaultHomestayActivityModel) formatPrimary(primary interface{}) string {
	return fmt.Sprintf("%s%v", cacheaiopsTravelHomestayActivityIdPrefix, primary)
}
