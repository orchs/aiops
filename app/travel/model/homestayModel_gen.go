...
var (
	...
	cacheaiopsTravelHomestayIdPrefix = "cache:aiopsTravel:homestay:id:"
)
...
func (m *defaultHomestayModel) Insert(ctx context.Context, session sqlx.Session, data *Homestay) (sql.Result, error) {
	...
	aiopsTravelHomestayIdKey := fmt.Sprintf("%s%v", cacheaiopsTravelHomestayIdPrefix, data.Id)
	...
	}, aiopsTravelHomestayIdKey)
}

func (m *defaultHomestayModel) FindOne(ctx context.Context, id int64) (*Homestay, error) {
	aiopsTravelHomestayIdKey := fmt.Sprintf("%s%v", cacheaiopsTravelHomestayIdPrefix, id)
	var resp Homestay
	err := m.QueryRowCtx(ctx, &resp, aiopsTravelHomestayIdKey, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) error {
...
func (m *defaultHomestayModel) formatPrimary(primary interface{}) string {
	return fmt.Sprintf("%s%v", cacheaiopsTravelHomestayIdPrefix, primary)
}
