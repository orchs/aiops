...
var (
	...
	cacheaiopsTravelHomestayCommentIdPrefix = "cache:aiopsTravel:homestayComment:id:"
)
...
func (m *defaultHomestayCommentModel) Insert(ctx context.Context, session sqlx.Session, data *HomestayComment) (sql.Result, error) {
	...
	aiopsTravelHomestayCommentIdKey := fmt.Sprintf("%s%v", cacheaiopsTravelHomestayCommentIdPrefix, data.Id)
	...
	}, aiopsTravelHomestayCommentIdKey)
}

func (m *defaultHomestayCommentModel) FindOne(ctx context.Context, id int64) (*HomestayComment, error) {
	aiopsTravelHomestayCommentIdKey := fmt.Sprintf("%s%v", cacheaiopsTravelHomestayCommentIdPrefix, id)
	var resp HomestayComment
	err := m.QueryRowCtx(ctx, &resp, aiopsTravelHomestayCommentIdKey, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) error {
...
func (m *defaultHomestayCommentModel) formatPrimary(primary interface{}) string {
	return fmt.Sprintf("%s%v", cacheaiopsTravelHomestayCommentIdPrefix, primary)
}
