...
var (
	...
	cacheaiopsSysUserIdPrefix     = "cache:aiopsSys:user:id:"
	cacheaiopsSysUserMobilePrefix = "cache:aiopsSys:user:mobile:"
)
...
func (m *defaultUserModel) Insert(ctx context.Context, session sqlx.Session, data *User) (sql.Result, error) {
	...
	aiopsSysUserIdKey := fmt.Sprintf("%s%v", cacheaiopsSysUserIdPrefix, data.Id)
	aiopsSysUserMobileKey := fmt.Sprintf("%s%v", cacheaiopsSysUserMobilePrefix, data.Mobile)
	...
	}, aiopsSysUserIdKey, aiopsSysUserMobileKey)
}

func (m *defaultUserModel) FindOne(ctx context.Context, id int64) (*User, error) {
	aiopsSysUserIdKey := fmt.Sprintf("%s%v", cacheaiopsSysUserIdPrefix, id)
	var resp User
	err := m.QueryRowCtx(ctx, &resp, aiopsSysUserIdKey, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) error {
...
func (m *defaultUserModel) FindOneByMobile(ctx context.Context, mobile string) (*User, error) {
	aiopsSysUserMobileKey := fmt.Sprintf("%s%v", cacheaiopsSysUserMobilePrefix, mobile)
	var resp User
	err := m.QueryRowIndexCtx(ctx, &resp, aiopsSysUserMobileKey, m.formatPrimary, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) (i interface{}, e error) {
...
func (m *defaultUserModel) formatPrimary(primary interface{}) string {
	return fmt.Sprintf("%s%v", cacheaiopsSysUserIdPrefix, primary)
}
