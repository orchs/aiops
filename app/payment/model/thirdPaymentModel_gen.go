...
var (
	...
	cacheaiopsPaymentThirdPaymentIdPrefix = "cache:aiopsPayment:thirdPayment:id:"
	cacheaiopsPaymentThirdPaymentSnPrefix = "cache:aiopsPayment:thirdPayment:sn:"
)
...
func (m *defaultThirdPaymentModel) Insert(ctx context.Context, session sqlx.Session, data *ThirdPayment) (sql.Result, error) {
	...
	aiopsPaymentThirdPaymentIdKey := fmt.Sprintf("%s%v", cacheaiopsPaymentThirdPaymentIdPrefix, data.Id)
	aiopsPaymentThirdPaymentSnKey := fmt.Sprintf("%s%v", cacheaiopsPaymentThirdPaymentSnPrefix, data.Sn)
	...
	}, aiopsPaymentThirdPaymentIdKey, aiopsPaymentThirdPaymentSnKey)
}

func (m *defaultThirdPaymentModel) FindOne(ctx context.Context, id int64) (*ThirdPayment, error) {
	aiopsPaymentThirdPaymentIdKey := fmt.Sprintf("%s%v", cacheaiopsPaymentThirdPaymentIdPrefix, id)
	var resp ThirdPayment
	err := m.QueryRowCtx(ctx, &resp, aiopsPaymentThirdPaymentIdKey, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) error {
...
func (m *defaultThirdPaymentModel) FindOneBySn(ctx context.Context, sn string) (*ThirdPayment, error) {
	aiopsPaymentThirdPaymentSnKey := fmt.Sprintf("%s%v", cacheaiopsPaymentThirdPaymentSnPrefix, sn)
	var resp ThirdPayment
	err := m.QueryRowIndexCtx(ctx, &resp, aiopsPaymentThirdPaymentSnKey, m.formatPrimary, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) (i interface{}, e error) {
...
func (m *defaultThirdPaymentModel) Update(ctx context.Context, session sqlx.Session, data *ThirdPayment) (sql.Result, error) {
	...
	}, aiopsPaymentThirdPaymentSnKey, aiopsPaymentThirdPaymentIdKey)
}
...
func (m *defaultThirdPaymentModel) formatPrimary(primary interface{}) string {
	return fmt.Sprintf("%s%v", cacheaiopsPaymentThirdPaymentIdPrefix, primary)
}
