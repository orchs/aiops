...
var (
	...
	cacheaiopsUsercenterUserAuthIdPrefix              = "cache:aiopsUsercenter:userAuth:id:"
	cacheaiopsUsercenterUserAuthAuthTypeAuthKeyPrefix = "cache:aiopsUsercenter:userAuth:authType:authKey:"
	cacheaiopsUsercenterUserAuthUserIdAuthTypePrefix  = "cache:aiopsUsercenter:userAuth:userId:authType:"
)
...
func (m *defaultUserAuthModel) Insert(ctx context.Context, session sqlx.Session, data *UserAuth) (sql.Result, error) {
	...
	aiopsUsercenterUserAuthIdKey := fmt.Sprintf("%s%v", cacheaiopsUsercenterUserAuthIdPrefix, data.Id)
	aiopsUsercenterUserAuthAuthTypeAuthKeyKey := fmt.Sprintf("%s%v:%v", cacheaiopsUsercenterUserAuthAuthTypeAuthKeyPrefix, data.AuthType, data.AuthKey)
	aiopsUsercenterUserAuthUserIdAuthTypeKey := fmt.Sprintf("%s%v:%v", cacheaiopsUsercenterUserAuthUserIdAuthTypePrefix, data.UserId, data.AuthType)
	...
	}, aiopsUsercenterUserAuthUserIdAuthTypeKey, aiopsUsercenterUserAuthIdKey, aiopsUsercenterUserAuthAuthTypeAuthKeyKey)
}

func (m *defaultUserAuthModel) FindOne(ctx context.Context, id int64) (*UserAuth, error) {
	aiopsUsercenterUserAuthIdKey := fmt.Sprintf("%s%v", cacheaiopsUsercenterUserAuthIdPrefix, id)
	var resp UserAuth
	err := m.QueryRowCtx(ctx, &resp, aiopsUsercenterUserAuthIdKey, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) error {
...
func (m *defaultUserAuthModel) FindOneByAuthTypeAuthKey(ctx context.Context, authType string, authKey string) (*UserAuth, error) {
	aiopsUsercenterUserAuthAuthTypeAuthKeyKey := fmt.Sprintf("%s%v:%v", cacheaiopsUsercenterUserAuthAuthTypeAuthKeyPrefix, authType, authKey)
	var resp UserAuth
	err := m.QueryRowIndexCtx(ctx, &resp, aiopsUsercenterUserAuthAuthTypeAuthKeyKey, m.formatPrimary, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) (i interface{}, e error) {
...
func (m *defaultUserAuthModel) FindOneByUserIdAuthType(ctx context.Context, userId int64, authType string) (*UserAuth, error) {
	aiopsUsercenterUserAuthUserIdAuthTypeKey := fmt.Sprintf("%s%v:%v", cacheaiopsUsercenterUserAuthUserIdAuthTypePrefix, userId, authType)
	var resp UserAuth
	err := m.QueryRowIndexCtx(ctx, &resp, aiopsUsercenterUserAuthUserIdAuthTypeKey, m.formatPrimary, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) (i interface{}, e error) {
...
func (m *defaultUserAuthModel) Delete(ctx context.Context, session sqlx.Session, id int64) error {
	...
	}, aiopsUsercenterUserAuthIdKey, aiopsUsercenterUserAuthAuthTypeAuthKeyKey, aiopsUsercenterUserAuthUserIdAuthTypeKey)
	return err
}

func (m *defaultUserAuthModel) formatPrimary(primary interface{}) string {
	return fmt.Sprintf("%s%v", cacheaiopsUsercenterUserAuthIdPrefix, primary)
}
